...
/** Quanti contatti si caricano per la tendina: stessa soglia di agenda/nuova/page.tsx. */
...
// quindi non è un walk-in. Rispetto ad "Aggiungi in agenda" (permesso
// 'agenda-nuova'), qui si registra soltanto (mai una programmazione futura),
// solo telefonata o email, e la trattativa che si apre resta da assegnare
// invece di andare a chi la scrive — vedi le prop passate a NuovaVoce e la
// logica in creaVoce (app/dashboard/agenda/actions.ts).
