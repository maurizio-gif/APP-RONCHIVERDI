...
// L'interruttore chiaro/scuro, in cima al menu accanto al campanello: sono
// due preferenze del dispositivo che si toccano una volta sola, quindi stanno
// affiancate e hanno la stessa forma — pittogramma sopra, etichetta sotto.
//
...
export function TemaToggle() {
  ...
  return (
    <button
      type="button"
      className={`strumento-btn tema-btn${scuro ? ' is-scuro' : ''}`}
      onClick={alterna}
      aria-pressed={scuro}
    ...
    >
      <span className="tema-switch" aria-hidden="true">
        ...
        <svg
          ...
          strokeLinejoin="round"
        >
          {/* La falce è un cerchio pieno con un morso, disegnata in un tratto
              solo: due cerchi sovrapposti in tratto si vedono entrambi. */}
